...
<page backbottom="14mm" style="font-size: 12pt; font-family: freeserif; width: 100%">
        ...
        <tr>
            <td align="left" style="width: 32%;">
                <table style="width: 100%;">
                    <tr>
                        <td style="width:30%;"><img src="img_data/images/<?php echo $SETTINGS['company_stamp']['value']; ?>" style="width:100%;height:auto;display:inline-block;"></td>
                        <td style="width:70%;"><img src="img_data/images/<?php echo $SETTINGS['website_logo']['value']; ?>" style="width:100%;height:auto;display:inline-block;" class="logo"></td>
                    </tr>
                </table>
            </td>
    ...
    <div class="note" style="width:100%;padding:20px 20px;">
                        ...
                        <tr>
                            <td style="width:50%;">
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td>Ngày kí:</td>
                                        <td><?php echo 'Ngày ' . date('d') . ' tháng ' . date('m') . ' năm ' . date('Y'); ?></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:50%;">
