			...
			foreach ($inDateProducts as $i => $product) {
				...
				<tr>
					...
					<td>
                        ...
                        &nbsp;
                        <a data-id="<?php echo $product['id_sanpham']; ?>" href="javascript:void(0)" title="Đổi ảnh" class="btn-change-img" data-title="<?php echo $product['alias_vi']; ?>">
				...
				result.push(`
					<tr role="row">
						...
						<td>
                            ...
                            <a data-id="${item.id_sanpham}" href="javascript:void(0)" title="Đổi ảnh" class="btn-change-img" data-title="${item.alias_vi}">
                                <i class="glyphicon glyphicon-picture"></i>
                            </a>
						</td>
					</tr>
