<nav class="navbar navbar-inverse" role="navigation">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-left class_conghau">
				<li>
				...
				<li>
					<?php  
						// đơn hàng
						$sql = "select id from #_dathang where trang_thai = 0";
		        ...
		        <li>
		        	<div class="thongbao_lienhe view_website">
						<a class="clear-cat-button" href="#" target='_blank'>Xóa cache</a>
					</div>
		        </li>
				<li>
					<div class="thongbao_lienhe navbar-text text-light nav-toggle-button">
						Hình SP:
						<span class="info-toggle-button">
							<input type="checkbox" id="change_show_image" <?php echo ADMIN_IMAGE === true ? 'checked' : ''; ?>>
						</span>
					</div>
				</li>
			</ul>
