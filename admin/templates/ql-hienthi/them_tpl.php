                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td_right">
                                    ...
                                    <p style="margin:0"><label for="view_nhan_hieu_is_featured"><input <?php echo ($view_nhan_hieu == 'is_featured_and_group')?'checked="checked"':''?> id="view_nhan_hieu_is_featured" type="radio" name="view_nhan_hieu" value="is_featured_and_group"> Nhãn hiệu tiêu biểu và nhóm nhãn hiệu thu gọn</label></p>
