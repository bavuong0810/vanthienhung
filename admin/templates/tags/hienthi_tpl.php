<ol class="breadcrumb">
  ...
  <li class="active"><a href="<?=urladmin ?>index.php?p=tags&a=man">Giao diện</a></li>
</ol>
...
<table class="table table-bordered table-hover">
	<thead>
		<tr>
			...
			<!-- <th style="width:35%; text-align:left">Tên tags</th> -->
	...
	<tbody>
		...
		<tr>
			...
			<td style="text-align:left">
				<a href="index.php?p=tags&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_vi']?></a>
				<br/>
				<a href="index.php?p=tags&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_en']?></a>
				<br/>
				<a href="index.php?p=tags&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_ch']?></a>
			</td>
			<!-- <td>
				<input class="chk_box" type="checkbox" onclick="on_check(this,'#_tags','is_home','<?=$items[$i]['id']?>')" <?php if($items[$i]['is_home'] == 1) echo 'checked="checked"'; ?>>
			</td> -->
			<td>
