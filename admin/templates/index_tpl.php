...
<style type="text/css">
        ...
        .login-header .alert-custom{ height: 163px; }
...
<div class="col-xs-12 text-center">
	<!-- <div class="col-xs-6 col-xs-offset-3">
		<div class="info-custom">
	        ...
	        <div class="huong-dan">
	            <ul>
	                <li>Gửi yêu cầu vào email: <span class="red">xe.xenang@gmail.com</span></li>
	                <li>Gọi số Hotline HTKH: <?php echo getenv('FIRST_PHONE'); ?></li>
	            </ul>
	        </div>
	    </div>
	</div> -->
			        ...
			        <div class="alert alert-success alert-custom">
			            ...
			            <div class="huong-dan">
			                <ul>
			                    ...
			                    <li>Gọi số Hotline HTKH: <span class="red"><?php echo $SETTINGS['tell_contact']['value']; ?></span></li>
			                </ul>
			            </div>
			        </div>
			    </div>
