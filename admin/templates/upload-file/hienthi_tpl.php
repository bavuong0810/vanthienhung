...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><?=($i+1)?></td>
			<td>
				<a href="index.php?p=upload-file&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_vi']?></a>
			</td>
			<td>
				<div>
				...
				<div class="hide_all <?=$items[$i]['id']?>_2" style="  text-align: left;    border-bottom: 1px solid #EAEAEA;  margin-bottom: 7px; ">
					...
					<input onclick="selec_all(this)" style="   background: none; width: 90%; float:right;  border: none;" type="text" value='<audio class="html5_audio" controls=""><source src="<?=FILEURL."img_data/".$items[$i]['link']  ?>" type="audio/mpeg"></audio>'>
					<div style="clear:both"></div>
					<div style="font-size: 12px;    color: red;">
				...
				<div class="hide_all <?=$items[$i]['id']?>_3" style="  text-align: left;    border-bottom: 1px solid #EAEAEA;  margin-bottom: 7px; ">
					...
					<input onclick="selec_all(this)" style="   background: none; width: 90%; float:right;  border: none;" type="text" value='<video src="<?=FILEURL."img_data/".$items[$i]['link']  ?>" width="400px" controls="controls" loop="loop"></video>'>
					<div style="clear:both"></div>
					<div style="font-size: 12px;    color: red;">
				...
				<div class="hide_all <?=$items[$i]['id']?>_4" style="  text-align: left;    border-bottom: 1px solid #EAEAEA;  margin-bottom: 7px; ">
					...
					<input onclick="selec_all(this)" style="   background: none; width: 90%; float:right;  border: none;" type="text" value="<iframe frameborder='0' scrolling='no' style='width:100%' src='<?=FILEURL."readpdf/pdf/index.php?f=" ?><?=FILEURL."img_data/".$items[$i]['link']  ?>'></iframe>">
					<div style="clear:both"></div>
					<div style="font-size: 12px;    color: red;">
				...
				<div class="hide_all <?=$items[$i]['id']?>_5" style="  text-align: left;    border-bottom: 1px solid #EAEAEA;  margin-bottom: 7px; ">
					...
					<input onclick="selec_all(this)" style="   background: none; width: 90%; float:right;  border: none;" type="text" value="<object type='application/x-shockwave-flash' data='<?=FILEURL."img_data/".$items[$i]['link']  ?>' width='100%' height='1100'><param name='movie' value='<?=FILEURL."img_data/".$items[$i]['link']  ?>' /><param name='quality' value='high'/><param name='wmode' value='transparent'/></object>">
					<div style="clear:both"></div>
					<div style="font-size: 12px;    color: red;">
