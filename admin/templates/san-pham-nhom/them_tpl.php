...
<ol class="breadcrumb">
	...
	<li class="active"><a href="<?= urladmin ?>index.php?p=san-pham-nhom&a=man">Sản phẩm nhóm</a></li>
	<li class="active"><a href="#"><?php if (isset($_GET['id'])) echo "Sửa";
									else echo "Thêm mới" ?></a></li>
</ol>
<div class="col-xs-12">
	<form name="CHm" method="post" action="index.php?p=san-pham-nhom&a=save&id=<?= @$_REQUEST['id'] ?>&page=<?= @$_REQUEST['page'] ?>" enctype="multipart/form-data">
		...
		<div class="ar_admin last fixed-bottom text-center" style="position: sticky; top: 0; bottom: auto; box-shadow: none; margin-bottom: 10px;">
			...
			<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=san-pham-nhom&a=man'" class="btn btn-default" />
			<?php if (isset($_GET['id'])) { ?>
				&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin/index.php?p=san-pham-nhom&a=delete&id=<?php echo $items[0]['id']; ?>" class="text-danger">Xóa</a>
			<?php } ?>
		</div>
		...
		<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
			<ul id="myTabs" class="nav nav-tabs" role="tablist">
				...
				<li role="presentation">
					<a href="#list_child_product" id="list_child_product-tab" role="tab" data-toggle="tab" aria-controls="list_child_product" aria-expanded="false">Danh sách sản phẩm</a>
				</li>
				<li role="presentation">
					<a href="#id_viet" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">Ngôn ngữ VN </a>
				</li>
				<li role="presentation" class="">
					<a href="#id_us" role="tab" id="id_us-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Ngôn ngữ EN</a>
				</li>
				<li role="presentation" class="">
					<a href="#id_ch" role="tab" id="id_ch-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Ngôn ngữ CH</a>
				</li>
				<li role="presentation" class="">
					<a href="#id_seo" role="tab" id="id_seo-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Hỗ trợ SEO</a>
				</li>
			...
			<div id="myTabContent" class="tab-content">
					...
					<div class="ar_admin">
						...
						<div class="row form-group">
							<?php if ($mainProduct['product_type'] == ProductConfigs::TYPE_PRODUCT) : ?>
								...
								<div class="col-md-3">
									<select name="parent_number" class="input width400 form-control selectpicker" data-live-search="true" style="border-radius:4px">
										<option value="0">Chọn sản phẩm lớn</option>
										<?php foreach ($parents as $parent) : ?>
											<option value="<?php echo $parent['parent_number'] ?>" <?php echo @$items[0]['parent_number'] == $group['parent_number'] ? 'selected' : '' ?>>
							...
							?>
								...
								<div class="col-md-3">
									<input class="input width400 form-control field-need-check" id="parent_number" name="parent_number" data-result="parent_number_result" value="<?php echo @$items[0]['parent_number'] ?>" />
									<div id="parent_number_result" class="error-message text-danger"></div>
								</div>
							<?php
							}
							?>
				...
				<div role="tabpanel" class="tab-pane fade" id="list_child_product" aria-labelledby="list_child_product-tab">
					<!-- \\list_child_product -->
					<div class="ar_admin">
						<?php include('parts/add-new-child.php'); ?>
						<?php include('parts/child-products.php'); ?>
					</div>
				</div>
			...
			$.ajax('/admin/api.php', {
				...
				success: data => {
					if (data.length > 0) {
						...
						resultElement.html('Đã tồn tại ' + name + ' giống: ' + data.length + ' sản phẩm');
						return;
					}
