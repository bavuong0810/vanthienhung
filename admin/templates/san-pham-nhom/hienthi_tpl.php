...
<ol class="breadcrumb sticky-left">
	...
	<li class="active"><a href="<?= urladmin ?>index.php?p=san-pham-nhom&a=man">Sản phẩm</a></li>
</ol>

<div class="col-xs-12 sticky-left">
	<form action="index.php">
		<div class="form-group tac-vu">
			<input type="hidden" name="p" value="san-pham-nhom" />
	...
	<div class="btn-group">
		<select id="action" onchange="search(this,'san-pham-nhom')" name="action" class="form-control">
	    ...
	    jQuery(document).ready(function($) {
	        $('input#search').keypress(function (e) {
	         var key = this.value;
	           if (e.which == 13) {
	             window.location = "index.php?p=san-pham-nhom&a=man&search=name&key="+key;
	           }
	        });        
	    }); 
	</script> -->
			...
			<a href="index.php?p=san-pham-nhom&a=man&remove_filter" class="text-danger">Xóa bộ lọc</a>
			...
			<div class="pull-right">
				<a href="index.php?p=san-pham-nhom&a=add" class="btn btn-primary">
					<i class="glyphicon glyphicon-plus"></i> Thêm mới
				</a>
				<a href="index.php?p=san-pham-nhom&a=import" class="btn btn-info">
...
<div class="col-xs-12">
	...
	<form id="form" method="post" action="index.php?p=san-pham-nhom&a=delete_all" role="form">
				...
				?>
					<tr>
						...
						<td>
							...
							<a href="index.php?p=san-pham-nhom&a=edit&id=<?= $items[$i]['id'] ?>&page=<?= @$_GET['page'] ?>" class="text-danger" title="Sửa"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;&nbsp;&nbsp;
							<a href="index.php?p=san-pham-nhom&a=delete&id=<?= $items[$i]['id'] ?>&page=<?= @$_GET['page'] ?>" onClick="if(!confirm('Xác nhận xóa?')) return false;" class="text-danger" title="Xóa"><i class="glyphicon glyphicon-remove"></i></a>
						</td>
						<td><?php echo $items[$i]['parent_number']; ?></td>
						<td style="text-align:left" class="break-word">
							<a href="index.php?p=san-pham-nhom&a=edit&id=<?= $items[$i]['id'] ?>&page=<?= @$_GET['page'] ?>"><?= $items[$i]['name_vi'] ?></a>
						...
						<td class="break-word">
							<a href="index.php?p=san-pham-nhom&a=edit&id=<?= $items[$i]['id'] ?>&page=<?= @$_GET['page'] ?>"><?= $items[$i]['name_en'] ?></a>
						</td>
						<td class="break-word">
							<a href="index.php?p=san-pham-nhom&a=edit&id=<?= $items[$i]['id'] ?>&page=<?= @$_GET['page'] ?>"><?= $items[$i]['name_ch'] ?></a>
						</td>
						<td>
							<?php if (ADMIN_IMAGE): ?>
...
?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			cloneProduct(<?php echo $_GET['clone_id']; ?>, 'san-pham-nhom');
		});
	</script>
