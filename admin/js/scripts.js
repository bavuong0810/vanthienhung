var App = function () {
    ...
    return {
        ...
        init: function () {
            ...
            if (jQuery.browser && jQuery.browser.msie && jQuery.browser.version.substr(0, 1) == 8) {
...
$('#change_show_image').on('change', (e) => {
    const isShowImage = $(e.target).prop('checked');
    $.cookie('admin_image', isShowImage, { expires: 365 });
    location.reload();
});
...
const initImagePlaceholder = () => {
    const showImage = (e) => {
        ...
        img.width = 200;
        img.src = `${AppConfig.fileBaseUrl}images/200/140/${path}?zc=2`;

        e.target.parentNode.replaceChild(img, e.target);
    };
    $('.image-placeholder').on('click', showImage);
};
