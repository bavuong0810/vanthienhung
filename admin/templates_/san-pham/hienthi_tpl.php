...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="index.php?p=san-pham&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=($items[$i]['image_path'] <> '')?"<img src='".URLPATH."thumb.php?src=".URLPATH."img_data/images/".$items[$i]['image_path']."&w=70&h=50&zc=2'>":""; ?></a>
			</td>
