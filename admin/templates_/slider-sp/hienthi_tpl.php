...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="index.php?p=slider-sp&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><img src="../img_data/images/<?=$items[$i]['image_path']?>" alt="" style="max-width:50px; max-height:50px"></a>
			</td>
			<!-- 
			<td>
