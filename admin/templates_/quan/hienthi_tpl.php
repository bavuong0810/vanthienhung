	...
	<tbody>
		...
		<tr>
			...
			<td style=" text-align:left">
				<?php 
					$thanhpho = $d->o_sel("*","#_thanhpho","id = '".$items[$i]['category_id']."'","so_thu_tu asc");
					echo "[".$thanhpho[0]['name_vi']."]";
				?>
			</td>
			<td style=" text-align:left">
				<a href="index.php?p=quan&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_vi']?></a> 
			</td>
