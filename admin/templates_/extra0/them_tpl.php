...
<ol class="breadcrumb">
  ...
  <li class="active"><a href="<?=urladmin ?>index.php?p=gear_type&a=man"> Text link</a></li>
  <li class="active"><a href="#"><?php if(isset($_GET['id'])) echo "Sửa"; else echo "Thêm mới" ?></a></li>
</ol>
<div class="col-xs-12">
<form name="frm" method="post" action="index.php?p=gear_type&a=save&id=<?=@$_REQUEST['id']?>&page=<?=@$_REQUEST['page']?>" enctype="multipart/form-data">
		...
		<table class="table table-bordered table-hover them_dt" style="border:none">
			<tbody>
				...
				<tr>
					...
					<td class="td_right">
						<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=gear_type&a=man'" class="btn btn-primary" />
					</td>
				</tr>
			</tbody>
		</table>
