...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td style="text-align:left">
				<a href="index.php?p=bat-dong-san&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_vi']?></a>
				<br/>
				<a href="index.php?p=bat-dong-san&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_en']?></a>
				<br/>
				<a href="index.php?p=bat-dong-san&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_ch']?></a>
			</td>
			</td>
			<td>
				<a href="index.php?p=bat-dong-san&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=($items[$i]['image_path'] <> '')?"<img src='".FILEURL."thumb.php?src=".FILEURL."img_data/images/".$items[$i]['image_path']."&w=70&h=50'>":""; ?></a>
			</td>
