	...
	<tbody>
		...
		<tr>
			...
			<td style=" text-align:left">
				<a href="index.php?p=hinh-thuc-thanh-toan&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_vi']?></a> 
				<br/>
				 <a href="index.php?p=hinh-thuc-thanh-toan&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><?=$items[$i]['name_en']?></a>
			</td>
